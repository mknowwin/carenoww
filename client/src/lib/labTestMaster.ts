...
export const LAB_TEST_MASTER: LabTestMaster = {
  ...
  "ECHO": [
    { name: "LV Ejection Fraction",        unit: "%",         referenceRange: "55 – 70",      defaultValue: "60"   },
    { name: "LV Function",                 unit: "",          referenceRange: "Normal",       defaultValue: "Normal" },
    { name: "RV Function",                 unit: "",          referenceRange: "Normal",       defaultValue: "Normal" },
    { name: "Valves",                      unit: "",          referenceRange: "Normal",       defaultValue: "No significant valvular abnormality" },
    { name: "Pericardium",                 unit: "",          referenceRange: "Normal",       defaultValue: "No effusion" },
    { name: "Interpretation",              unit: "",          referenceRange: "—",            defaultValue: "Normal study" },
  ],
  "TMT": [
    { name: "Protocol",                    unit: "",          referenceRange: "Bruce",        defaultValue: "Bruce" },
    { name: "Exercise Duration",           unit: "min:sec",   referenceRange: "—",             defaultValue: "9:00" },
    { name: "Max Heart Rate Achieved",     unit: "bpm",       referenceRange: "≥ 85% predicted", defaultValue: "150" },
    { name: "BP Response",                 unit: "",          referenceRange: "Normal",       defaultValue: "Normal" },
    { name: "ST Changes",                  unit: "",          referenceRange: "None",         defaultValue: "None" },
    { name: "Interpretation",              unit: "",          referenceRange: "—",            defaultValue: "Negative for inducible ischemia" },
  ],
  "Holter": [
    { name: "Monitoring Duration",         unit: "hrs",       referenceRange: "24",           defaultValue: "24" },
    { name: "Average Heart Rate",          unit: "bpm",       referenceRange: "60 – 100",     defaultValue: "78" },
    { name: "Min / Max Heart Rate",        unit: "bpm",       referenceRange: "—",             defaultValue: "55 / 130" },
    { name: "Arrhythmias Noted",           unit: "",          referenceRange: "None",         defaultValue: "None significant" },
    { name: "Interpretation",              unit: "",          referenceRange: "—",            defaultValue: "No significant rhythm abnormality" },
  ],
  "ABP": [
    { name: "Monitoring Duration",         unit: "hrs",       referenceRange: "24",           defaultValue: "24" },
    { name: "Average Daytime BP",          unit: "mmHg",      referenceRange: "< 135/85",     defaultValue: "128/82" },
    { name: "Average Nighttime BP",        unit: "mmHg",      referenceRange: "< 120/70",     defaultValue: "112/68" },
    { name: "Dipping Pattern",             unit: "",          referenceRange: "Dipper",       defaultValue: "Dipper" },
    { name: "Interpretation",              unit: "",          referenceRange: "—",            defaultValue: "Normal ambulatory BP profile" },
  ],
  "Chest X-Ray": [
